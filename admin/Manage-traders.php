...
<button class="btn btn1"><a href="Verify-traders.php"> Verify</a></button>
...
<?php
 ...
 while ($value = oci_fetch_array($queeryok)) {
    ...
    <td>'.$value['ADDRESS'].'</td>
    <td> <a href = "Deactivate-trader.php?id='.$value['USER_ID'].' ">Activate</a></td></tr>';
 ...
 if($value['IS_VERIFIED'] == 2){
    ...
    <td>'.$value['PHONENUMBER'].'</td>
    <td>'.$value['ADDRESS'].'</td>
    <td> <a href = "Activate-trader.php?id='.$value['USER_ID'].' ">Deactivate</a></td></tr>
    ';
