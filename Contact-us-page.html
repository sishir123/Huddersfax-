...
<html>
	...
	<body>
		...
		<nav>
			...
			<ol>
				<li>
					<a href="Wishlistpage.html" class="Hover-btn"
						><i class="fa-regular fa-heart"></i> Wishlist</a
					>
				</li>
				<li>
					<a href="Addtocart.html" class="Hover-btn"
						><i class="fa-solid fa-cart-shopping"></i> Cart</a
					>
				</li>
				<li>
					<a href="Login/index.html" class="Hover-btn"
		...
		<div class="footer-container">
			...
			<div class="Huddersfax-mart Links">
				<ol>
					<li>
						<a href="About-us.html" class="links-btn">About us</a>
					</li>
